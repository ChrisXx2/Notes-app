...
/*
I had no idea how to use JSDoc when I started this project, so I went back and added
JSDoc comments after the fact to help document the code for future me
and anyone else who might work on this project.

I used https://jsdoc.app/ and AI to help me understand how to write JSDoc comments.
...
/**
 * Checks if element should be visible based on search term
 * @param {Array<string>} searchableContent - Array of text to search through
...
/**
 * Applies saved position, size, and color to an element
 * @param {HTMLElement} element - The element to style
 * @param {Object} backedItem - Saved item data with position, width, height, color
 * @param {boolean} isNew - Whether this is a newly created item
 */
...
/**
 * Finalizes element setup: visibility, interactions, and board attachment
 * @param {HTMLElement} element - The element to finalize
 ...
 * @param {Object} backedItem - Saved note data (null if new)
 * @param {string} title - Note title
 * @param {string} text - Note content
 * @param {boolean} isNew - Whether this is a newly created note
 */
 ...
 * @param {Object} backedItem - Saved checklist data (null if new)
 * @param {string} title - Checklist title
 * @param {Object} itemsArray - Object with items array
 * @param {boolean} isNew - Whether this is a newly created checklist
 */
